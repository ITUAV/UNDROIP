refunction sss_data = unit_test_dv (fname, dir_in, varargin)
...
% % Example 1: 
  ...
  defaults.dir_in = 'C:\Users\Mohammed\Desktop\Swarms project\Sonar data and viewer\DV_dataset_2\WEs'; % name of the directory that contains the images, change it to your directory
  defaults.fname ='WE5.dvs';  % name of the DVS file you want to read
%  
...
[sss_data] = read_side_scan_sonar_dvs(args.fname);
...
sss_data = enhance_sss_image(sss_data, 'spline_tol', 1E-7);
% 
% 
