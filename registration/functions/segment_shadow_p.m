function imgS=segment_shadow_p(WF,thresS,sizeMinS,sizeMaxS,Area_minS,Ex_min,ratio_max,Hwater,hmin,d_obj_min)

%%%%%%%%%%%%%%%%%%%%%%
%%%
%%% segmentation of shadows on portside
%%%
%%% I. Leblond
%%%
...
j_landmk=ceil(sizeS(:,1))+sizeS(:,3)-1; %position of landmarks across track (end of bounding box for portside)
